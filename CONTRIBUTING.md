...
# Contribute to Ory k8s-toolbox<!-- omit in toc -->
...
_Please note_: We take Ory k8s-toolbox's security and our users' trust very
seriously. If you believe you have found a security issue in Ory k8s-toolbox,
...
k8s-toolbox's direction. A great way to
do this is via
[Ory k8s-toolbox Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/k8s-toolbox/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory k8s-toolbox?](#communication)
...
- I want to talk to other Ory k8s-toolbox users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  k8s-toolbox.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/k8s-toolbox)

- I would like updates about new versions of Ory k8s-toolbox.
...
[list of good first issues](https://github.com/ory/k8s-toolbox/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory k8s-toolbox.
...
- **Help with open issues.** We have a lot of open issues for Ory k8s-toolbox and
...
Check out [Ory k8s-toolbox Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory k8s-toolbox,
...
before getting started to ensure your work is consistent with Ory k8s-toolbox's
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/k8s-toolbox/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/k8s-toolbox).
...
git clone git@github.com:ory/ory/k8s-toolbox.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/k8s-toolbox.git
